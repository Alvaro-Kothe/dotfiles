...
theme.mem = theme.icon_dir .. "/memory.png"
...
theme.mpd = lain.widget.mpd({
  settings = function()
    ...
    elseif mpd_now.state == "pause" then
      widget:set_markup(
        markup.font("Roboto 4", " ") .. markup.font(theme.taglist_font, " MPD PAUSED  ") .. markup.font("Roboto 5", " ")
      )
...
local bat = lain.widget.bat({
  settings = function()
    ...
    if bat_now.ac_status == 1 then
      bat_p = bat_p .. "Carregando "
    end
    bat_p = bat_p .. "(" .. bat_now.time .. ")"
...
local system_load = lain.widget.sysload({
  settings = function()
    widget:set_markup(space3 .. markup.font(theme.font, "Load " .. load_1) .. markup.font("Roboto 5", " "))
  end,
})
